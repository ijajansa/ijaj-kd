		...
		<div class="page-wrapper">
			<div class="page-content">
				<div style="width: 100%;display: flex;">
					<div style="width:50%">
					<h6 class="mb-0 text-uppercase" style="display:inline-block;">All Subadmin</h6>					
					</div>
					<div style="width:50%">
					<p align="right"><a href="{{route('admins.create')}}" class="btn btn-primary mb-3 mb-lg-0"><i class='bx bxs-plus-square'></i>Add New Subadmin</a></p>	
					</div>
				</div>
				<hr/>
