					...
					<div class="card-body p-5">
						<div class="card-title d-flex align-items-center">
							...
							<div style="width: 100%;display: flex;">
            					<div style="width:100%">
            					<h5 class="mb-0 text-primary" style="display:inline-block;">C&D Waste Sale & Reuse Form</h5>					
            					</div>
            					<div style="width:50%">
						...
						<hr>
						<form class="row g-3" method="POST" enctype="multipart/form-data" action="{{url('cd-processed/add')}}">
							@csrf
							...
							<div class="col-md-4">
								...
								<select class="form-control multiple-select form-select @error('category') is-invalid @enderror"  name="category">
									...
									<option value="sale" @if(old('category')=='sale') selected @endif>Sale</option>
