		...
		<div class="page-wrapper">
			<div class="page-content">
				<div style="width: 100%;display: flex;">
				    ...
				    <div style="width:50%">
					<p align="right"><a href="{{url('cd-processed/export-excel')}}" class="btn btn-warning mb-3 mb-lg-0"><i class='bx bxs-download'></i>Export Excel</a>&nbsp;&nbsp;<a href="{{url('cd-processed/export-pdf')}}" class="btn btn-danger mb-3 mb-lg-0"><i class='bx bxs-download'></i>Export PDF</a></p>	
					</div>
				</div>
				<hr/>
								...
								<tbody>
								    @foreach($data as $key=>$record)
                                     <tr>
                                        ...
                                        <td>{{$record->category=='sale' ? $record->weight : 0}}</td>
